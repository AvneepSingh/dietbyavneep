...
def register(request):
    ...
    if request.method == 'POST':
        ...
        data = {'Messages': [{
                        ...
                        "HTMLPart": "<h3>Dear "+username+", welcome to Dietician!</h3><br><h4><a href='http://"+ip+":8000/login'>click on the link to verify email</a></h4><br><br><i>May the force be with you!</i>"}]
                }

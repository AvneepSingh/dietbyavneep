...
def main():
    ...
    event = {
      ...
      "attendees": [{"email": sys.argv[1],},{"email":sys.argv[2]}],
    ...
    data = {'Messages': [{
                    ...
                    "To": [{"Email": str(sys.argv[1]),"Name": "Coach"},{"Email": str(sys.argv[2]),"Name": "You"}],
                    "Subject": "here your gmeet link",
                    "TextPart": "Greetings from Dietician!",
                    "HTMLPart": "<h3><br>"+str(link)+"<br></h3>"}]
            }
